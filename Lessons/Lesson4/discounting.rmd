...
#Paid_HH_sml <- order(Paid_HH_sml$dy) zle
#daju sa este spravit este dalsie vsetky take kombinacie
```
...
#vznikne trojuholnik s ay ako riadkami, dy ako stlpcami a so SomOfamount ako hodnotami v trojuhilniku
```{r}
```
